    ...
    public function index($id = '') {
        ...
        if (htmlspecialcharscustom($this->input->post('submit'))) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $outlet_info['email_send_auto'] = htmlspecialcharscustom($this->input->post('email_send_auto'));
                $outlet_info['whatsapp_send_auto'] = htmlspecialcharscustom($this->input->post('whatsapp_send_auto'));
                ...
                // Handle ZATCA OTP
                $outlet_info['zatca_otp'] = htmlspecialcharscustom($this->security->xss_clean($this->input->post('zatca_otp')));
