    ...
    public function addEditFoodMenu($encrypted_id = "") {
        ...
        if (htmlspecialcharscustom($this->input->post('submit'))) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $food_menu_info['calories'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('calories')));
                ...
                if(isset($vr_tax_counter) && $vr_tax_counter){
                    ...
                    if(!empty($_POST['vr_tax_counter'])){
                        ...
                        foreach($this->input->post('vr_tax_counter') as $key=>$value){
                            ...
                            $variation_calories_arr = $this->input->post('variation_calories');
                            $food_menu_info_vr['calories'] = (is_array($variation_calories_arr) && isset($variation_calories_arr[$key])) ? htmlspecialcharscustom($variation_calories_arr[$key]) : '';
