...
<input type="hidden" class="is_saas" value="<?php echo isServiceAccess('','','sGmsJaFJE')?>">
                    ...
                    <ul class="sidebar-menu ps ps--active-x ps--active-y tree" data-widget="tree">
                        ...
                        <li class="treeview menu__cidirp_32 check_main_menu common_use">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li data-access="" class="" data-menu__cid="irp_32"><a class="child-menu" href="<?php echo base_url(); ?>WhiteLabel">
                        ...
                        <li class="treeview menu__cidirp_1515">
                            <a href="javascript:void(0)">
                            ...
                            <ul class="treeview-menu">
                                <li data-access="view-321" class="menu_assign_class" data-menu__cid="irp_1515"><a class="child-menu" href="<?php echo base_url()?>Short_message_service/smsService"><?php echo lang('sms_settings'); ?></a></li>
                                <li data-access="all_setting-358" class="menu_assign_class" data-menu__cid="irp_1515"><a class="child-menu" href="<?php echo base_url()?>Frontend/emailSetting"><?php echo lang('email_setting'); ?></a></li>
                                <li data-access="view-332" class="menu_assign_class" data-menu__cid="irp_1515"><a class="child-menu" href="<?php echo base_url()?>Frontend/whatsappSetting"> <?php echo lang('whatsapp_setting'); ?></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview menu__cidirp_9 item_stock">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li data-access="view-346" class="menu_assign_class" data-menu__cid="irp_9"><a class="child-menu" href="<?php echo base_url()?>Inventory/inventoryFoodMenu">
  ...
  <?php if(APPLICATION_MODE == 'demo'): ?> 
    ...
    $language_manifesto = isset($company->language_manifesto) ? $company->language_manifesto : '';
    ?>
    <div class="cta-demo-link" style="text-align:center;display:none;">
    ...
    <div class="cta-default-whatsapp" style="text-align:center;">
        <a class="btn btn-success custom_shadow_wp" href="https://wa.me/8801812391633" target="_blank" rel="noopener">
        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="WhatsApp" role="img">
  <path fill="#25D366" d="M16 3C9.383 3 4 8.383 4 15c0 2.155.573 4.267 1.657 6.12L4 29l8.123-1.616A11.94 11.94 0 0 0 16 27c6.617 0 12-5.383 12-12S22.617 3 16 3z"/>
  <path fill="#FFFFFF" d="M23.2 19.1c-.3-.2-1.8-.9-2.1-1s-.5-.2-.7.2-.8 1-1 1.2-.4.2-.7 0c-.3-.2-1.3-.5-2.4-1.5-.9-.8-1.5-1.8-1.7-2.1s0-.5.2-.7c.2-.2.3-.4.5-.6.2-.2.2-.3.3-.5.1-.2 0-.4 0-.6 0-.2-.7-1.7-.9-2.3-.2-.6-.5-.5-.7-.5h-.6c-.2 0-.6.1-.9.4-.3.3-1.2 1.2-1.2 2.9s1.2 3.3 1.4 3.5c.2.2 2.3 3.5 5.6 4.9.8.3 1.4.5 1.8.6.8.2 1.5.2 2 .1.6-.1 1.8-.7 2-1.4.2-.7.2-1.3.1-1.4 0-.2-.3-.3-.6-.5z"/>
  <path fill="#25D366" d="M16 6.2c-4.85 0-8.8 3.95-8.8 8.8 0 1.64.46 3.24 1.34 4.64l-.88 3.2 3.28-.86A8.74 8.74 0 0 0 16 23.8c4.85 0 8.8-3.95 8.8-8.8S20.85 6.2 16 6.2zm0 16.1c-1.46 0-2.89-.38-4.16-1.1l-.3-.17-1.95.51.52-1.9-.2-.31a7.3 7.3 0 0 1-1.17-3.96c0-4.03 3.28-7.3 7.3-7.3s7.3 3.28 7.3 7.3-3.28 7.3-7.3 7.3z"/>
</svg>
 Any questions?</a>
    </div>
 <?php endif;?>
...
?>
    ...
    <script>window.APPLICATION_MODE = '<?php echo (defined("APPLICATION_MODE") ? APPLICATION_MODE : "live"); ?>';</script>
    <script src="<?php echo base_url(); ?>frequent_changing/js/demo-cta.js"></script>
</body>
