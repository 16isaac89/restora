...
<?php
    ...
    if(isset($register_info) && count($register_info)>0){
        ...
        foreach($register_info as $single_register_info){
            ...
            $z_report_link = base_url() . 'Report/cashierZReport/' . $this->custom->encrypt_decrypt($single_register_info->id, 'encrypt');
            $show_register_report .= '<td><a class="btn btn-xs bg-blue-btn" href="'.$z_report_link.'">'.lang('z_report').'</a></td>';
            $show_register_report .= "</tr>";        
            $i++;
        }
    }
                    ...
                    <table id="datatable" class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="title" class="ir_w_10"><?php echo lang('action'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
