...
<section class="main-content-wrapper">
    ...
    <div>
        ...
        ?>
        <h4 class="txt-color-grey"><?= isset($start_date) && $start_date && isset($end_date) && $end_date ? lang('date').": " . date($this->session->userdata('date_format') . ' H:i', strtotime($start_date)) . " - " . date($this->session->userdata('date_format') . ' H:i', strtotime($end_date)) : '' ?><?= isset($start_date) && $start_date && !$end_date ? lang('date').": " . date($this->session->userdata('date_format') . ' H:i', strtotime($start_date)) : '' ?><?= isset($end_date) && $end_date && !$start_date ? lang('date').": " . date($this->session->userdata('date_format') . ' H:i', strtotime($end_date)) : '' ?>
        </h4>
