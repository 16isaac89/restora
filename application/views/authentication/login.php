...
<div class="container">
    <div class="row">
        ...
        <div class="container">
            ...
            ?>
            <div class="cta-demo-link" style="text-align:center;margin-top:10px;display:none;">
            ...
            <div class="cta-default-whatsapp" style="text-align:center;margin-top:10px;">
                <a class="btn btn-success custom_shadow" href="https://wa.me/8801812391633" target="_blank" rel="noopener"><i class="fa fa-whatsapp"></i> Any questions?</a>
            </div>
             <?php endif;?>
            <div class="card alt">
