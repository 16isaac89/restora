...
?>
  ...
  <?php
                            ...
                            <div class="mb-3 col-sm-12 col-md-4 col-lg-3">
                                <div class="form-group">
                                    <label> <?php echo lang('email_send_auto'); ?> </label>
                                    <select tabindex="7" class="form-control select2" name="email_send_auto"
                                            id="email_send_auto">
                                        <option
                                            <?= isset($outlet_information) && $outlet_information->email_send_auto== "1" ? 'selected' : '' ?>
                                                value="1"><?php echo lang('no')?></option>
                                        <option
                                            <?= isset($outlet_information) && $outlet_information->email_send_auto== "2" ? 'selected' : '' ?>
                                                value="2"><?php echo lang('yes')?></option>
                                    </select>
                                </div>
                                <?php if (form_error('email_send_auto')) { ?>
                                    <div class="callout callout-danger my-2">
                                        <?php echo form_error('email_send_auto'); ?>
                                    </div>
                                <?php } ?>
                            </div>
                            <div class="mb-3 col-sm-12 col-md-4 col-lg-3">
                                <div class="form-group">
                                    <label> <?php echo lang('whatsapp_send_auto'); ?> </label>
                                    <select tabindex="7" class="form-control select2" name="whatsapp_send_auto"
                                            id="whatsapp_send_auto">
                                        <option
                                            <?= isset($outlet_information) && $outlet_information->whatsapp_send_auto== "1" ? 'selected' : '' ?>
                                                value="1"><?php echo lang('no')?></option>
                                        <option
                                            <?= isset($outlet_information) && $outlet_information->whatsapp_send_auto== "2" ? 'selected' : '' ?>
                                                value="2"><?php echo lang('yes')?></option>
                                    </select>
                                </div>
                                <?php if (form_error('whatsapp_send_auto')) { ?>
                                    <div class="callout callout-danger my-2">
                                        <?php echo form_error('whatsapp_send_auto'); ?>
                                    </div>
                                <?php } ?>
                            </div>
                            <?php
                                ...
                                <div class="card">
                                    <div class="card-header bg-light">
                                        <h6 class="mb-0">
                                            ...
                                            <small class="text-muted">(Saudi E-Invoicing API Settings)</small>
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>ZATCA API OTP (One-Time Password)</label>
                                                    <input tabindex="100" autocomplete="off" type="text" 
                                                           name="zatca_otp" 
                                                           id="zatca_otp"
                                                           class="form-control" 
                                                           placeholder="Enter 6-digit OTP from ZATCA Portal"
                                                           maxlength="6"
                                                           value="<?php echo isset($outlet_information->zatca_otp) ? escape_output($outlet_information->zatca_otp) : ''; ?>">
                                                    <small class="form-text text-muted">
                                                        Required for ZATCA API authentication. Get this from 
                                                        <a href="https://gw-fatoora.zatca.gov.sa/e-invoicing/developer-portal" target="_blank">ZATCA Developer Portal</a>
                                                    </small>
                                                </div>
                                                <?php if (form_error('zatca_otp')) { ?>
                                                <div class="callout callout-danger my-2">
                                                    <?php echo form_error('zatca_otp'); ?>
                                                </div>
                                                <?php } ?>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="alert alert-info">
                                                    <strong>How to get ZATCA OTP:</strong>
                                                    <ol class="mb-0 ps-3">
                                                        <li>Visit <a href="https://gw-fatoora.zatca.gov.sa/e-invoicing/developer-portal" target="_blank">ZATCA Portal</a></li>
                                                        <li>Login with your credentials</li>
                                                        <li>Navigate to API Settings</li>
                                                        <li>Generate a new OTP (6-digit code)</li>
                                                        <li>Copy and paste the OTP here</li>
                                                    </ol>
                                                </div>
                                            </div>
                                        </div>
