...
<input type="hidden" id="loggedin_designation" value="<?php echo escape_output($this->session->userdata('designation'))?>">
...
<input type="hidden" id="email_send_auto_checker" value="<?php echo isset($email_send_auto) && $email_send_auto==2?1:0?>">
<input type="hidden" id="whatsapp_send_auto_checker" value="<?php echo isset($whatsapp_send_auto) && $whatsapp_send_auto==2?1:0?>">
...
<input type="hidden" id="inv_paid_ticket" value="">
...
<input type="hidden" id="write_your_reason_reset" value="<?php echo lang('write_your_reason_reset'); ?>">
