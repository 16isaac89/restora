...
<?php
    ...
    if($wl){
        ...
        if(isset($wl->favicon) && $wl->favicon){
...
<body>
    ...
    <div id="main-wrapper-content" class="wrapper">
            ...
            <div class="left_item">
                <div class="header_part_middle">
                    ...
                    <ul class="icon__menu">
                        ...
                        <li>
                            <a href="#" class="header_menu_icon open_expense_modal_trigger no-need-for-waiter <?php echo escape_output($is_self_order_class) ?>"
                                data-tippy-content="<?php echo lang('expense'); ?>">
        ...
        <div class="top_header_for_mobile <?php echo escape_output($is_self_order_class)?'self_order_mode':'' ?>">
            <div class="for-table-mode <?php echo escape_output($is_self_order_class)?'self_order_mode':'' ?>">
                ...
                <!-- End Types -->
                <button type="button" class="table_button bg__blue">
                    <i class="fal fa-table"></i> <span><?php echo lang('table'); ?></span>
                </button>
                ...
                <div class="customer-add-edit">
                    ...
                    <button type="button" class="header_menu_icon bg__khoyre open_expense_modal_trigger no-need-for-waiter <?php echo escape_output($is_self_order_class) ?>"
                        data-tippy-content="<?php echo lang('expense'); ?>">
                        <i class="fas fa-receipt"></i>
                    </button>
                </div>
            ...
            <div class="for-mobile-mode">
                ...
                <div class="type-btn-list button_holder no-need-for-waiter">
                    ...
                    <div class="btn-list">
                        <button class="tablet_btn type_temp_div <?php echo escape_output(isset($waiter_app_status) && $waiter_app_status=="Yes"?'active_tmp_btn':(isset($default_order_type) && $default_order_type==1?'active_tmp_btn':''))?>" data-id="1">
                            <i class="fal fa-table"></i> <?php echo lang('dine'); ?>
                        </button>
                        <button class="tablet_btn type_temp_div <?php echo escape_output(isset($default_order_type) && $default_order_type==2?'active_tmp_btn':'')?>" data-id="2"><i class="fal fa-shopping-bag"></i>
                            <?php echo lang('take_away'); ?></button>
                        <?php
                        $mobile_delivery_selected = (isset($default_order_type) && $default_order_type==3?'active_tmp_btn':'');
                        if(!isFoodCourt()):
                            ?>
                            <button class="tablet_btn type_temp_div <?php echo escape_output($mobile_delivery_selected)?>" data-id="3"><i class="fal fa-truck"></i>
                                <?php echo lang('delivery'); ?></button>
                            <?php
                        elseif($this->session->userdata('role') == 'Admin'):
                            ?>
                ...
                <button type="button" class="table_button bg__blue"><span><?php echo lang('table'); ?></span></button>
                ...
                <div class="main_middle" style="<?php echo escape_output($is_self_order_class)?'width: 100%;':'' ?>">
                    <div class="main_top">
                        ...
                        <div class="button_holder <?php echo escape_output($is_self_order_class) ?> <?php echo isset($is_self_order_class) && $is_self_order_class?'':'no-need-for-waiter' ?>">
                            ...
                            ?>
                            <button class="table_button <?php echo escape_output($is_self_order_class) ?>"><i class="fal fa-table"></i> <?php echo lang('table'); ?></button>
                    ...
                    <div class="waiter_customer">
                        <div class="left_item <?php echo escape_output($is_self_order_class) ?> <?php echo isFoodCourt()?'isFoodCourt':''?>">
                                ...
                                <button class="table_button half-width-98"><i class="fal fa-table"></i>
                        ...
                        <div class="bottom__info">
                            ...
                            <div class="main_bottom">
                                <div class="button_group <?php echo escape_output($is_self_order_class) ? 'self_order_mode': '' ?>">
                                    ...
                                    <button data-type="1" class="<?php echo escape_output(isset($is_online_order) && $is_online_order=="Yes"?'self_order_skip':'')?> <?php echo escape_output(isset($is_self_order) && $is_self_order=="Yes"?'self_order_skip':'')?> placeOrderSound place_order_operation no-need-for-waiter <?php echo isset($place_order_tooltip) && $place_order_tooltip=="show"?"btn_tip":'' ?>"   data-tippy-content="<?php echo lang('place_order_tooltip_txt'); ?>"><i
    ...
    <div class="all__menus">
        <ul class="menu__list">
            <div>
                ...
                <li>
                    <a href="#" class="action_go_to_dashboard_mobile">
                        <i class="fal fa-tachometer-alt-fast"></i>
                        <?php
                        if ($this->session->userdata('role') == 'Admin') {
                            echo lang('dashboard');
                ...
                <li>
                    <a href="<?php echo base_url();?>Authentication/logOut" class="mobile_others_logout">
                        <i class="fal fa-sign-out"></i> <?php echo lang('logout'); ?>
                    </a>
                </li>
                <li>
                    <a href="#" class="close_all_menu_mobile">
                        <i class="fal fa-times"></i> <?php echo lang('close'); ?>
                    </a>
                </li>
    ...
    <div id="expense_modal" class="modal">
        <div class="modal-content">
            <h1><?php echo lang('add_expense'); ?>
                <a href="javascript:void(0)" class="alertCloseIcon">
                    <i class="fal fa-times"></i>
                </a>
            </h1>
            <div class="customer_add_modal_info_holder">
                <div class="expense_modal_intro">
                    <?php echo lang('add_expense'); ?> details
                </div>
                <div class="expense_form_grid">
                    <div class="customer_section">
                        <p class="input_level"><?php echo lang('date'); ?></p>
                        <input type="date" id="expense_date_modal" class="add_customer_modal_input" value="<?php echo date('Y-m-d'); ?>">
                    </div>
                    <div class="customer_section">
                        <p class="input_level"><?php echo lang('amount'); ?></p>
                        <input type="text" id="expense_amount_modal" class="add_customer_modal_input integerchk" placeholder="<?php echo lang('amount'); ?>">
                    </div>
                    <div class="customer_section">
                        <p class="input_level"><?php echo lang('category'); ?></p>
                        <select id="expense_category_modal" class="add_customer_modal_input">
                            <option value=""><?php echo lang('select'); ?> <?php echo lang('category'); ?></option>
                            <?php foreach ($expense_categories as $ec) { ?>
                            <option value="<?php echo escape_output($ec->id); ?>"><?php echo escape_output($ec->name); ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="customer_section">
                        <p class="input_level"><?php echo lang('responsible_person'); ?></p>
                        <select id="expense_employee_modal" class="add_customer_modal_input">
                            <option value=""><?php echo lang('select'); ?> <?php echo lang('responsible_person'); ?></option>
                            <?php foreach ($users as $empls) { ?>
                            <option value="<?php echo escape_output($empls->id); ?>"><?php echo escape_output($empls->full_name); ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="customer_section">
                        <p class="input_level"><?php echo lang('payment_method'); ?></p>
                        <select id="expense_payment_modal" class="add_customer_modal_input">
                            <option value=""><?php echo lang('select'); ?> <?php echo lang('payment_method'); ?></option>
                    ...
                    <div class="customer_section expense_note_field">
                        <p class="input_level"><?php echo lang('note'); ?></p>
                        <textarea id="expense_note_modal" class="add_customer_modal_input" rows="4" placeholder="<?php echo lang('note'); ?>"></textarea>
                    </div>
                </div>
                <div class="bottom_button_holder_table_modal">
                    <button type="button" id="close_expense_modal"><?php echo lang('cancel'); ?></button>
                    <button type="button" id="save_expense_modal"><?php echo lang('submit'); ?></button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="select_table_modal_info_holder2">
                ...
                <div class="table-category-list bg-white pos_p_10">
                    ...
                    <ul class="dineIn-table-list-of-item">
                         <?php
                            $i = 1;
                            $tables_grouped_by_area = array();
                            if(isset($tables_for_pos) && $tables_for_pos){
                                foreach ($tables_for_pos as $single_table){
                                    $area_key = isset($single_table->area) ? $single_table->area : '';
                                    if($area_key !== ''){
                                        if(!isset($tables_grouped_by_area[$area_key])){
                                            $tables_grouped_by_area[$area_key] = array();
                                        }
                                        $tables_grouped_by_area[$area_key][] = $single_table;
                                    }
                                }
                            }
                            foreach ($areas as $value) {
                                ...
                                $i++;
                                $design_html = isset($value->table_design_content) ? $value->table_design_content : '';
                                $has_table_nodes = (strpos((string)$design_html, 'get_table_details') !== false);
                                if((trim((string)$design_html) === '' || !$has_table_nodes) && isset($tables_grouped_by_area[$value->id])){
                                    $fallback_html = '';
                                    foreach ($tables_grouped_by_area[$value->id] as $table_item){
                                        $fallback_html .= '<div class="div_rectangular area_all_table area_table_'.escape_output($value->id).'">';
                                        $fallback_html .= '<div class="div_box">';
                                        $fallback_html .= '<h5 class="trigger_to_select_other get_table_details" data-id="'.escape_output($table_item->id).'" data-hidden_table_capacity="'.escape_output($table_item->sit_capacity).'" data-booked_id="" data-order_number="" data-merge_id="" data-name="'.escape_output($table_item->name).'">'.escape_output($table_item->name).'</h5>';
                                        $fallback_html .= '</div>';
                                        $fallback_html .= '</div>';
                                    }
                                    $design_html = $fallback_html;
                                }
                                echo '<li><div class="set_design ir_display_none">'.$design_html.'</div><a class="get_area_table" data-floor_bg_color="'.(!empty($value->floor_bg_color) ? $value->floor_bg_color : '').'"  data-ordered_border_color="'.$value->ordered_border_color.'"  data-ordered_bg_color="'.$value->ordered_bg_color.'"  data-ordered_text_color="'.$value->ordered_text_color.'" data-id="'.$value->id.'" href="javascript:void(0)">'.$value->area_name.'</a></li>';
                            }
                        ?>
                    </ul>
    ...
    <div class="cus_pos_modal" id="register_modal">
        ...
        <footer class="pos__modal__footer">
            <div class="right_box">
                <button type="button"  id="register_close"><?php echo ($designation=="Cashier" ? 'End Session' : lang('close_register')); ?></button>
...
<div class="cus_pos_modal cus_pos_modal_self_online_sale_modal" id="customModalSelfOnlineOrder">
                ...
                <div class="payment-list order-payment-list">
                    <ul class="list-for-payment-type">
                        ...
                        <?php foreach ($payment_method_finalize as $value):
                            ...
                            $is_mobile_money = (stripos($value->name, 'mobile') !== false || stripos($value->name, 'momo') !== false);
                            if($is_loyalty_enable!='enable'):
                                if($value->id!=5):
                            ?>
                                <li>
                                    <a class="<?php echo escape_output($is_cash)?> <?php echo escape_output($selected)?> set_payment" data-mobile-money="<?php echo $is_mobile_money ? '1' : '0'; ?>" data-name="<?php echo escape_output($value->name)?>" data-id="<?php echo escape_output($value->id)?>" href="#"><?php echo escape_output($value->name)?></a>
                                </li>
                                <?php
                                    endif;
                                else:?>
                        ...
                        <div id="tab-1">
                            ...
                            <div class="payment-amount">
                                <div class="top-layer">
                                    ...
                                    <div class="input-field mobile_money_div display_none">
                                        <p class="label set_no_access">Phone Number</p>
                                        <input type="text" placeholder="256..." class="add_customer_modal_input set_no_access" id="finalize_phone_number">
                                    </div>
                                    <div class="btns">
                                    ...
                                    <div class="paid-list-wrapper">
                                        ...
                                        <div class="right-content">
                                            ...
                                            <div class="item">
                                              ...
                                              $email_send_auto = $this->session->userdata('email_send_auto');
                                              $whatsapp_send_auto = $this->session->userdata('whatsapp_send_auto');
                                              $company_id = $this->session->userdata('company_id');
                                              $company = companyInformation($company_id);
                                              
                                              // Check if services are enabled
                                              $sms_enabled = isset($company->sms_service_provider) && $company->sms_service_provider;
                                              $email_enabled = false;
                                              $whatsapp_enabled = false;
                                              
                                              // Check email settings
                                              if(isset($company->email_settings) && $company->email_settings){
                                                  $emailSettings = json_decode($company->email_settings);
                                                  $email_enabled = isset($emailSettings->enable_status) && $emailSettings->enable_status == "1";
                                              }
                                              
                                              // Check WhatsApp settings
                                              if(isset($company->whatsapp_settings) && $company->whatsapp_settings){
                                                  $whatsappSettings = json_decode($company->whatsapp_settings);
                                                  $whatsapp_enabled = isset($company->whatsapp_service_provider) && $company->whatsapp_service_provider;
                                              }
                                             
                                              
                                              if($sms_enabled || $email_enabled || $whatsapp_enabled):
                                              ?>
                                                <table class="irp_width_100">
                                                    <tr>
                                                        <?php if($sms_enabled): ?>
                                                        <td>
                                                            <button for="check_send_sms">
                                                                <label class="check_send_sms">
                                                                    <input id="check_send_sms" <?php echo isset($sms_send_auto) && $sms_send_auto==2?'checked':''?> type="checkbox">
                                                                    <i class="fas fa-envelope irp_width_20" title="<?php echo lang('send_sms'); ?>"></i> <br><small class="irp_width_9"><?php echo lang('sms'); ?></small>
                                                                </label>
                                                            </button>
                                                        </td>
                                                        <?php endif; ?>
                                                        ...
                                                        <td>
                                                            <button for="check_send_whatsapp">
                                                                <label class="check_send_whatsapp">
                                                                    <input id="check_send_whatsapp" <?php echo isset($whatsapp_send_auto) && $whatsapp_send_auto==2?'checked':''?> type="checkbox">
                                                                    <i class="fab fa-whatsapp irp_width_20" title="<?php echo lang('whatsapp'); ?>"></i> <br><small class="irp_width_9"><?php echo lang('whatsapp'); ?></small>
                                                                </label>
                                                            </button>
                                                        </td>
                                                        <?php endif; ?>
                                                        ...
                                                        <td>
                                                            <button for="check_send_mail">
                                                                <label class="check_send_mail">
                                                                    <input id="check_send_mail" <?php echo isset($email_send_auto) && $email_send_auto==2?'checked':''?> type="checkbox">
                                                                    <i class="fas fa-envelope irp_width_20" title="<?php echo lang('email'); ?>"></i> <br><small class="irp_width_9"><?php echo lang('email'); ?></small>
                                                                </label>
                                                            </button>
                                                        </td>
                                                        <?php endif; ?>
                                                        <td>
                                                            <button id="open_finalize_cart_details">
                                                                <i class="fas fa-info-circle irp_width_20" title="<?php echo lang('Cart_Details'); ?>"></i> <br><small class="irp_width_9"><?php echo lang('details'); ?></small>
                                                            </button>
                                                        </td>
                                                    </tr>
                                                </table>
    ...
    <div id="kot_list_modal" class="modal">
        ...
        <div class="modal-content" id="modal_kot_list_details">
            ...
            <div id="kot_table_content" class="fix">
                ...
                <div id="kot_item_content" class="fix ir_mt_15">
                    <h4 class="ir_mb_5"><?php echo lang('items'); ?></h4>
                    <div id="kot_tracking_summary" class="ir_mb_5"></div>
                    <div class="ir_mb_5">
                        <label for="kot_check_all">
                            <input type="checkbox" id="kot_check_all"> <?php echo lang('select_all'); ?>
                        </label>
                    </div>
                    <div id="kot_item_list_holder" class="scrollbar-macosx"></div>
                </div>
            </div>
            <div id="kot_bottom_buttons" class="fix">
                ...
                <button id="print_selected_kot_modal"><?php echo lang('print'); ?> Selected Items</button>
    ...
    <aside id="pos__sidebar">
        ...
        <ul class="pos__menu__list scrollbar-macosx">
            ...
            <li class="have_sub_menu menu_checker menu__cidirp_1515 common_use">
                <a class="open-trigger" href="javascript:void(0)">
                    <i data-feather="message-square"></i>
                    <span> &nbsp; <?php echo lang('all_common_setting'); ?></span>
                </a>
                <ul class="sub__menu__list">
                    <li data-access="view-321" class="menu_assign_class" data-menu__cid="irp_1515"><a href="<?php echo base_url()?>Short_message_service/smsService"><?php echo lang('sms_settings'); ?></a></li>
                    <li data-access="all_setting-358" class="menu_assign_class" data-menu__cid="irp_1515"><a href="<?php echo base_url()?>Frontend/emailSetting"><?php echo lang('email_setting'); ?></a></li>
                    <li data-access="view-332" class="menu_assign_class" data-menu__cid="irp_1515"><a href="<?php echo base_url()?>Frontend/whatsappSetting"><?php echo lang('whatsapp_setting'); ?></a></li>
                </ul>
            </li>
            ...
            <li class="have_sub_menu menu_checker menu__cidirp_11 item_stock">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li data-access="view-346" class="menu_assign_class" data-menu__cid="irp_9"><a href="<?php echo base_url()?>Inventory/inventoryFoodMenu">
            ...
            <li class="have_sub_menu menu_checker menu__cidirp_20 setting_report1">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li data-access="view-314" class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/cashierZReport">Cashier Z Report</a></li>
...
?>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>frequent_changing/js/pos_script_v7.3.js?v=7.6.10"></script>
