    ...
    <div id="receiptData">
        ...
        <div id="receipt-data">
            ...
            <table class="table table-condensed">
                ...
                ?>
                <?php
                if($sale_object->order_type!=3 && $sale_object->delivery_charge && $sale_object->delivery_charge!="0.00" && $sale_object->delivery_charge_actual_charge!="0" && $sale_object->delivery_charge_actual_charge):
                    ?>
                    <tr>
