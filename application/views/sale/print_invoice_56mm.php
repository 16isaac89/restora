        ...
        <div id="receiptData">
            ...
            <div id="receipt-data">
                ...
                <table style="width:100%">
                    <tr>
                        <td style="text-align:left;font-size:12px;"><b><?php echo $sale_object->sale_no; ?></b></td>
                        <td style="text-align:right;font-size:12px;"><b><?php echo $order_type?></b></td>
                    </tr>   
                </table>
               ...
               <p> 
                ...
                <table class="table table-condensed">
                    ...
                    <table class="table table-condensed">
                        ...
                        ?>
                        <?php
                        if($sale_object->order_type!=3 && $sale_object->delivery_charge_actual_charge && $sale_object->delivery_charge_actual_charge!="0.00" && $sale_object->delivery_charge_actual_charge!="0" && $sale_object->delivery_charge_actual_charge):
                        ?>
                        <tr>
                ...
                <table class="table table-striped table-condensed">
                    <tbody>
                        <tr>
                            <td style="font-size:12px;"><b><?php echo lang('total'); ?></b></td>
                            <td class="text-right">
                                <b style="font-size:12px;"><?php echo escape_output(getAmtCustom($sale_object->total_payable)); ?></b>
                            </td>
                        </tr>
...
<?php
                ...
                <p class="text-center"> <?php echo escape_output(getCompanyInfo()->invoice_footer) ?></p>
