<section class="main-content-wrapper">
    ...
    <div class="box-wrapper">
        ...
        <div class="table-box">
            ...
            <!-- /.box-body -->
            <p>&nbsp;</p>
            <button type="button" class="btn bg-blue-btn" id="register_close_details"><?php echo ($this->session->userdata('designation')=="Cashier" ? 'End Session' : lang('close_register')); ?></button>
        </div>
    </div>
</section>
