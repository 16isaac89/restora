                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <?php foreach ($week_days as $day_key=>$day_label): ?>
                                            ...
                                            $start_val = isset($_POST['schedule_start'][$day_key]) ? escape_output($_POST['schedule_start'][$day_key]) : '';
                                            $end_val = isset($_POST['schedule_end'][$day_key]) ? escape_output($_POST['schedule_end'][$day_key]) : '';
                                            ?>
                                            <tr>
