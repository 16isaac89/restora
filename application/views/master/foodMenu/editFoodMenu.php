            ...
            <div class="table-box">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                <label><?php echo lang('calories'); ?></label>
                                <input tabindex="1" type="text" id="calories" name="calories" class="form-control integerchk"
                                    placeholder="<?php echo lang('calories'); ?>"
                                    value="<?php echo escape_output($food_menu_details->calories) ?>">
                            </div>
                            <?php if (form_error('calories')) { ?>
                            <div class="callout callout-danger my-2">
                                <?php echo form_error('calories'); ?>
                            </div>
                            <?php } ?>
                            <div class="callout callout-danger my-2 error-msg calories_err_msg_contnr">
                                <p id="calories_err_msg"></p>
                            </div>
                        </div>
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <?php
                            ...
                            <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                <label><?php echo escape_output(getTaxLabel($tax_field->tax_field_name)) ?></label>
                        ...
                        <?php
                                                ...
                                                ?>
                                                        ...
                                                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                <label><?php echo escape_output(getTaxLabel($single_tax->tax)) ?></label>
                                <table class="ir_w_100">
                                    <tr>
                                        <td>
                                            <input tabindex="1" type="hidden" name="tax_field_id[]"
                                            ...
                                            <?php
                                                ...
                                                foreach($tax_information as $tax_field){ ?>
                                                        <div class="tax_details_view display_none">
                                                            ...
                                                            <input tabindex="1" type="text" class="form-control integerchk add_change_value vr01_tax_field_percentage" placeholder="<?php echo escape_output(getTaxLabel($tax_field->tax_field_name)) ?>" value="<?php  echo escape_output($tax_field->tax_field_percentage) ?>" name="vr01_tax_field_percentage1[]">
                                                        </div>
                    ...
                    <div class="row">
                        ...
                        if(isset($collect_tax) && $collect_tax=="Yes"):
                            ...
                            foreach($tax_setting as $tax_field){
                                ...
                                <div class="col-sm-12 mb-2 col-md-4">
                                    <div class="form-group">
                                        <label><?php echo escape_output(getTaxLabel($tax_field->tax)) ?></label>
                                        <table class="ir_w_100">
                                            <tr>
                                                <td class="tax_details">
                                                    ...
                                                    <input tabindex="1" type="text"
                                                           ...
                                                           placeholder="<?php echo escape_output(getTaxLabel($tax_field->tax)) ?>" value="<?php echo escape_output($tax_field->tax_rate)?>">
                                                </td>
                                                <td class="txt_27">%</td>
                                            </tr>
                                        </table>
                        ...
                        <div class="col-sm-12 col-md-4">
                            <div class="form-group">
                                <label><?php echo lang('calories'); ?></label>
                                <input tabindex="1" type="text" id="variation_calories" name="variation_calories" class="form-control integerchk"
                                       placeholder="<?php echo lang('calories'); ?>" value="">
                            </div>
                        </div>
                    </div>
