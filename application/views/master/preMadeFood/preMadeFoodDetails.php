...
<section class="main-content-wrapper">
    ...
    <div class="box-wrapper">
        <div class="table-box">
                ...
                <div>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <p class=""><?php echo escape_output(preMadeFoodcategoryName($food_menu_details->category_id)); ?></p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php if($food_menu_details->tax_information != ''){
                                    ...
                                    ?>
                                <span class="">
                                    <?php echo escape_output(getTaxLabel($val->tax_field_name)); ?>: <?php echo escape_output($val->tax_field_percentage); ?>%
                                    <?php
                    ...
                    <?php $food_menu_ingredients = preMadeFoodIngredients($food_menu_details->id); ?>
                ...
                <div class="row mt-2">
                    ...
                    <a class="btn bg-blue-btn w-100" href="<?php echo base_url() ?>preMadeFood/addEditFoodMenu/<?php echo escape_output($encrypted_id); ?>"><?php echo lang('edit'); ?>
                            </a>
    ...
    <div class="modal fade" id="featuredPhoto" role="dialog" aria-labelledby="myModalLabel">
