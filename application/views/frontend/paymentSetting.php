            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-12 mb-2 col-md-3">
                        <div class="form-group">
                            ...
                            <table class="ir_w_100">
                                <tr>
                                    <td>
                                        <select name="field_yopayments" class="form-control">
                                            <option <?php echo set_select('field_yopayments', "0"); ?> <?php echo isset($paymentSetting->field_yopayments) && $paymentSetting->field_yopayments=="0"?'selected':''?> value="0"><?php echo lang('Inactive'); ?></option>
                                            <option <?php echo set_select('field_yopayments', "1"); ?> <?php echo isset($paymentSetting->field_yopayments) && $paymentSetting->field_yopayments=="1"?'selected':''?> value="1"><?php echo lang('Active'); ?></option>
                                        </select>
                                    </td>
                                    <td>
                                        <select name="field_yopayments_v" class="form-control">
                                            <option <?php echo set_select('field_yopayments_v', "live"); ?> <?php echo isset($paymentSetting->field_yopayments_v) && $paymentSetting->field_yopayments_v=="live"?'selected':''?> value="live"><?php echo lang('Live'); ?></option>
                                            <option <?php echo set_select('field_yopayments_v', "sandbox"); ?> <?php echo isset($paymentSetting->field_yopayments_v) && $paymentSetting->field_yopayments_v=="sandbox"?'selected':''?> value="sandbox"><?php echo lang('Sandbox'); ?></option>
                                        </select>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div class="col-sm-12 mb-2 col-md-3">
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <input type="text" onfocus="select();" name="field_yopayments_key_1" class="form-control" placeholder="API Username" value="<?php echo isset($paymentSetting->field_yopayments_key_1) && $paymentSetting->field_yopayments_key_1?$paymentSetting->field_yopayments_key_1:set_value('field_yopayments_key_1')?>">
                            <?php if (form_error('field_yopayments_key_1')) { ?>
                                <div class="alert alert-error txt-uh-21 ir_p_5">
                                    <?php echo form_error('field_yopayments_key_1'); ?>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="col-sm-12 mb-2 col-md-3">
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <input type="text" onfocus="select();" name="field_yopayments_key_2" class="form-control" placeholder="API Password" value="<?php echo isset($paymentSetting->field_yopayments_key_2) && $paymentSetting->field_yopayments_key_2?$paymentSetting->field_yopayments_key_2:set_value('field_yopayments_key_2')?>">
                            <?php if (form_error('field_yopayments_key_2')) { ?>
                                <div class="alert alert-error txt-uh-21 ir_p_5">
                                    <?php echo form_error('field_yopayments_key_2'); ?>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
