...
<input type="hidden" id="is_variation_product" value="<?php echo isset($food_details->is_variation) ? (int)$food_details->is_variation : 0 ?>">
<input type="hidden" id="variation_parent_id" value="<?php echo isset($food_details->id) ? (int)$food_details->id : 0 ?>">
    ...
    <div class="row">
      ...
      <div class="col-md-7">
        <div class="product-content">
          ...
          <!-- Variation product dropdown (when is_variation = 1) -->
          <?php if (isset($food_details->is_variation) && $food_details->is_variation == 1): ?>
          <input type="hidden" id="please_select_variation_msg" value="<?php echo escape_output(lang('selected_variation')); ?>">
          <div class="form-group mb-3 variation-dropdown-wrapper" id="variation_dropdown_wrapper">
            <label for="variation_select"><?php echo lang('Variation'); ?></label>
            <select class="form-control" id="variation_select" name="variation_select">
          ...
          <form class="atc-form" method="post">
            ...
            <div class="d-flex gap20px align-items-end">
              <div class="form-group">
                ...
                <button type="button" name="button" class="btn-custom primary single_order" data_single_order_id="<?php echo $food_details->id ?>" id="btn_add_to_cart_details"><?php echo lang('add_to_cart'); ?> <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <?php if (isset($food_details->is_variation) && $food_details->is_variation == 1): ?>
          <div class="calories-info variation-product-calories" id="calories_info_wrapper" style="display:none;">
            <p><?php echo lang('calories'); ?>: <span id="variation_calories_value"></span></p>
          </div>
          <?php elseif (!empty($food_details->calories)) : ?>
          <div class="calories-info">
            <p><?php echo lang('calories'); ?>: <?php echo $food_details->calories; ?></p>
          </div>
          <?php endif; ?>
          <!-- /Add To Cart Form -->
        </div>
...
<script src="<?php echo base_url() ?>assets/website/js/variation.js"></script>